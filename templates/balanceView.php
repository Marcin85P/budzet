		...
		<div class="col-12 col-lg-6">
			<div id="table">		
					<table class="tb">	
						<thead>
							<tr>
								<th colspan="6" class="tableTitle" style="background-color:#446b43;">Przychody
									<?php 
		...
		<div class="col-12 col-lg-6">
			<div id="table">		
					<table class="tb">
						<thead>
							<tr>
								<th colspan="7" class="tableTitle" style="background-color:#b22222;">Wydatki
								<?php 
								if(isset($_SESSION['score'])){
									echo " ".$_SESSION['score'];
